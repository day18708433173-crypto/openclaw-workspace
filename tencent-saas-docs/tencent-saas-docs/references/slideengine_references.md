...
- SaaS 端: `https://saas.docs.qq.com/api/v6/slide/mcp`

调用示例：
```bash
# 默认直连 (零配置，自动从 WorkBuddy 读取 token)
python3 insert_image.py \
    --mcp-url "https://saas.docs.qq.com/api/v6/slide/mcp" \
    --image-path /tmp/chart.png \
    --tool-args '{"file_url":"https://saas.docs.qq.com/slide/XXX","page_index":0,"x":50,"y":50,"w":400,"h":300}'
...
python3 set_design.py \
    ...
    --tool-args '{"file_url":"https://saas.docs.qq.com/slide/XXX"}'
